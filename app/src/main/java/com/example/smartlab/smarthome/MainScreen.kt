...
import com.example.smartlab.smarthome.AddRoom
import com.example.smartlab.smarthome.Profile
import io.supabase.SupabaseClient

class MainScreen : AppCompatActivity() {
    private lateinit var mainAdressTextView: TextView // Виджет для отображения основного адреса
    private lateinit var supabaseClient: SupabaseClient // Инициализация клиента supabase
